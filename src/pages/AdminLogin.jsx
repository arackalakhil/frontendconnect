...
const AdminLogin=()=>{
    const {AdminLogins,authTokens}=useContext(AuthContext)
      ...
      <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div className="w-full p-8 lg:w-1/2">
                ...
                <a href="#" className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                    ...
                    <h1 className="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">ADMIN</h1>
                </a>
                ...
                <div className="mt-4">
                    ...
                    <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text" name="username"/>
                </div>
                <div className="mt-4">
