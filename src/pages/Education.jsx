...
const addEducation = async (e) => {
  ...
  // {
  await axios.post("http://127.0.0.1:8000/accounts/education", {
...
const updateEducation = async (e) => {
  ...
  await axios.put("http://127.0.0.1:8000/accounts/education", {
    id:preloaddata.id,
    institution: preloaddata.institution,
...
const DeleteData = (id) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      axios.delete(`http://127.0.0.1:8000/accounts/deleteEducation/${id}`, {
        headers: {
...
{console.log("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa111111112222",preloaddata)}
            ...
            <form onSubmit={(updateEducation)} >
              ...
              <div className="relative z-0 mb-6 w-full group">
                <input
                  ...
                  placeholder=""
                  defaultValue={preloaddata.institution}
...
{console.log("Ffffffffffffffffffffffffffffffffffffffffffiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiifffffffffffffffff")}
    ...
    <div className="bg-white p-8 rounded-md w-full">
      <div className=" flex items-center justify-between pb-6">
        <div>
          <h2 className="text-gray-600 font-semibold">Educatiton</h2>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="lg:ml-40 ml-10 space-x-8">
            ...
            <button className="bg-blue-500 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer" onClick={AddPopup}>Add New</button>
          </div>
        </div>
      </div>
      <div>
          ...
          <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                ...
                {data.map((list, id) => {
                  return (
                    ...
                    <tr>
                      ...
                      <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">{list.type}</p>
                      </td>
                      <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">
                          {list.join_date}
            ...
            <div
              ...
              <div className="inline-flex mt-2 xs:mt-0">
                <button
                  className="text-sm text-indigo-50 transition duration-150 hover:bg-blue-500 bg-blue-500 font-semibold py-2 px-4 rounded-l">
                  Prev
                </button>
                &nbsp; &nbsp;
                <button
                  className="text-sm text-indigo-50 transition duration-150 hover:bg-blue-500 bg-blue-500 font-semibold py-2 px-4 rounded-r">
                  Next
                </button>
              </div>
            </div>
